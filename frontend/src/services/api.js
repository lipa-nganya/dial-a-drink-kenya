...
const DEFAULT_DEV_API_BASE = 'https://deliveryos-backend-p6bkgryxqa-uc.a.run.app/api';
...
const resolveApiBaseUrl = () => {
  ...
  if (isNetlify) {
    ...
    // Any other Netlify host is treated as a production Netlify site and uses the production backend
    return {
