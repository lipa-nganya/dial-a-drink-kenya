...
const DEFAULT_LOCAL_API_BASE = 'http://localhost:5001/api/valkyrie/v1';
const DEFAULT_PRODUCTION_API_BASE = process.env.REACT_APP_VALKYRIE_API_URL || 'https://dialadrink-backend-910510650031.us-central1.run.app/api/valkyrie/v1';
...
api.interceptors.request.use(
  (config) => {
    const token = localStorage.getItem('valkyrieToken');
    if (token) {
