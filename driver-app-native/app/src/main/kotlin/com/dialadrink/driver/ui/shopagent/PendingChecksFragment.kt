...
class PendingChecksFragment : Fragment() {
    ...
    private fun displayChecks() {
        if (checks.isEmpty()) {
            ...
            binding.emptyStateText.text = "No pending inventory checks. All your submissions have been reviewed."
        ...
        inner class ViewHolder(private val binding: ItemInventoryCheckHistoryBinding) : RecyclerView.ViewHolder(binding.root) {
            fun bind(check: InventoryCheckHistoryItem) {
                ...
                try {
                    ...
                    binding.dateText.text = "Submitted: ${dateFormat.format(date)}"
                } catch (e: Exception) {
                    binding.dateText.text = "Submitted: ${check.createdAt}"
                }
                
                // Hide notes and recount button for pending
