...
class AdminProfileActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        binding.termsOfUseButton.setOnClickListener {
            ...
            intent.putExtra(com.dialadrink.driver.ui.common.TermsOfUseActivity.EXTRA_USER_TYPE, "admin")
            startActivity(intent)
        }
        
        binding.privacyPolicyButton.setOnClickListener {
            val intent = Intent(this, com.dialadrink.driver.ui.common.PrivacyPolicyActivity::class.java)
            intent.putExtra(com.dialadrink.driver.ui.common.PrivacyPolicyActivity.EXTRA_USER_TYPE, "admin")
            startActivity(intent)
        }
