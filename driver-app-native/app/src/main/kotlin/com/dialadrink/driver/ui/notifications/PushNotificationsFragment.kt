...
class PushNotificationsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loadAndDisplayPushNotifications()
    }
    ...
    private fun loadAndDisplayPushNotifications() {
        // Get push notifications from SharedPrefs (last 50)
        val allPushNotifications = SharedPrefs.getPushNotifications(requireContext())
        val pushNotifications = allPushNotifications.take(50) // Last 50
        
        displayPushNotifications(pushNotifications)
    }
    
    private fun displayPushNotifications(notifications: List<PushNotification>) {
        ...
        if (notifications.isEmpty()) {
            ...
            binding.emptyStateText.text = "No push notifications"
            return
        }
