...
class RejectedSubmissionsFragment : Fragment() {
    ...
    private fun displaySubmissions(submissions: List<CashSubmission>) {
        ...
        submissions.forEach { submission ->
            ...
            val rejectionReason = submission.rejectionReason?.trim().takeUnless { it.isNullOrEmpty() } ?: "No reason provided"
            receiptNumberText.text = "Rejected date and time: ${formatDateTime(submission.rejectedAt)}\nRejection reason: $rejectionReason"
