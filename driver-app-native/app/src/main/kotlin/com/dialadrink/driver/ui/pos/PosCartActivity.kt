...
class PosCartActivity : AppCompatActivity() {
    ...
    private val paymentMethods = listOf("Cash (Paid)", "Pay on Delivery")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupListeners()
        loadTerritories()
        // Default payment method to "Pay on Delivery" so rider can collect payment
        selectedPaymentMethod = "pay_on_delivery"
        binding.paymentMethodEditText.setText("Pay on Delivery")
        updateTotals()
    }
    ...
    private fun showPaymentMethodDialog() {
        val options = arrayOf("Cash (Paid)", "Pay on Delivery")
        ...
        AlertDialog.Builder(this)
            ...
            .setSingleChoiceItems(options, currentIndex) { dialog, which ->
                ...
                binding.paymentMethodEditText.setText(options[which])
                dialog.dismiss()
            }
            .setNegativeButton("Cancel", null)
            .show()
