...
#   1) Cloud Run: backend 1 vCPU / 512Mi, min 0 / max 10, concurrency 20; frontends same scaling.
...
export BACKEND_MEMORY="${BACKEND_MEMORY:-512Mi}"
...
export FRONTEND_MEMORY="${FRONTEND_MEMORY:-256Mi}"
