...
echo ""
echo "📋 Service URLs:"
echo "   Backend: https://dialadrink-backend-p6bkgryxqa-uc.a.run.app"
echo "   Frontend: https://dialadrink-customer-p6bkgryxqa-uc.a.run.app"
echo "   Admin: https://dialadrink-admin-p6bkgryxqa-uc.a.run.app"
echo ""
