...
echo ""
echo "📋 Service URLs:"
echo "   Backend: https://dialadrink-backend-910510650031.us-central1.run.app"
echo "   Frontend: https://drink-suite-customer-910510650031.us-central1.run.app"
echo "   Admin: https://drink-suite-admin-910510650031.us-central1.run.app"
echo ""
