...
3. **Advanced** (Optional):
   - **Substitution variables**:
     - `_SERVICE_NAME`: `dialadrink-backend`
     - `_REGION`: `us-central1`
...
```bash
# Backend logs
gcloud run services logs read dialadrink-backend --region us-central1

# Frontend logs
gcloud run services logs read dialadrink-customer --region us-central1

# Admin logs
gcloud run services logs read dialadrink-admin --region us-central1
```
