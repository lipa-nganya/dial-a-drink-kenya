...
const CashAtHandLogOverride = require('./CashAtHandLogOverride')(sequelize, Sequelize.DataTypes);
const DriverSavingsLogOverride = require('./DriverSavingsLogOverride')(sequelize, Sequelize.DataTypes);
...
db.CashAtHandLogOverride = CashAtHandLogOverride;
db.DriverSavingsLogOverride = DriverSavingsLogOverride;
