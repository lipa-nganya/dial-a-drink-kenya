...
async function applyStopDeductionFor432() {
  try {
    console.log('Applying stop deduction for Order 432...');
    
    const result = await applyStopDeduction(432);
