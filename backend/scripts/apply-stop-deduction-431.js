...
async function applyStopDeductionFor431() {
  try {
    console.log('Applying stop deduction for Order 431...');
    
    const result = await applyStopDeduction(431);
